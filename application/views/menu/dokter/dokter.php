          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <a href="<?php echo base_url().'index.php/Welcome/formDokter'?>" name="tambahDokter" class="btn btn-primary"><i class="fas fa-plus-circle"></i> Tambah Dokter</a>
                <?php endif; ?>
              ...
              <?php if($this->session->flashdata('pesanHapus')){echo $this->session->flashdata('pesanHapus');};?>
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  <?php if (!empty($dokter)) : foreach ($dokter as $row) : ?>
                  <tr>
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="btn-group ">
                                <button type="button" title="Detail" data-toggle="modal" name="tombolNich"
                                                            ...
                                                            data-id="<?php echo $row['dokter_idDokter']; ?>"
                                                            data-nama="<?php echo $row['nama_dokter']; ?>"
                                                            data-hp="<?php echo $row['no_hp_dokter']; ?>"
                                                            data-hari="<?php echo $row['Hari']; ?>"
                                                            data-alamat="<?php echo $row['alamat_dokter']; ?>"
                                ...
                                <button data-target="#konfirmasiDel" name="detil" title="Hapus"
                                                            data-id="<?php echo $row['dokter_idDokter']; ?>" data-toggle="modal"
                                                            class="btn btn-danger zoomPilih" href="#detailModal"
                                                            value="<?php echo $row['dokter_idDokter']; ?>"><i class="fas fa-user-slash"></i></button>
                                <?php endif;?>
                            </div>
                        </div>
                    </td>
    ...
    <div class="modal-dialog modal-confirm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="<?php echo base_url(); ?>index.php/Welcome/delDokter" method="POST">
...
<script>
  $(document).ready(function () {
        $('#detailModal').on('show.bs.modal', function (event) {
            ...
            modal.find('.modal-body #hari').html(button.data('hari'));
