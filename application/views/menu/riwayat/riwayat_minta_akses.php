<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Daftar Antrian Minta Akses</h1>
        </div>
        <div class="col-sm-6">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="d-flex justify-content-center">
                            <div class="btn-group ">
                              <button data-target="#kasiAkses" name="detil" title="Berikan Akses" data-id="<?php echo $row['idRiwayat']; ?>" data-toggle="modal" class="btn btn-info zoomPilih" ><i class="fas fa-check-circle"></i></button>
                              ...
                              <button data-target="#tolakAkses" name="detil2" title="Tolak Akses" data-id="<?php echo $row['idRiwayat']; ?>"  data-toggle="modal" class="btn btn-danger zoomPilih" ><i class="fas fa-times-circle"></i></button>
                              <!-- <button data-target="#konfirmasiDel" name="detil" title="Hapus"
                                                            data-id="<?php echo $row['idRiwayat']; ?>" data-toggle="modal"
                                                            class="btn btn-danger zoomPilih" href="#detailModal"
                                                            value="<?php echo $row['idRiwayat']; ?>"><i class="fas fa-user-slash"></i></button> -->
...
<div id="kasiAkses" class="modal fade">
  <div class="modal-dialog modal-confirm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Berikan akses kepada petugas agar dapat melihat detail pemeriksaan?</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-success" data-dismiss="modal">Tidak</button>
        <form action="<?php echo base_url(); ?>index.php/Welcome/kasiAkses" method="POST">
...
<div id="tolakAkses" class="modal fade">
  <div class="modal-dialog modal-confirm">
    <div class="modal-content">
      <div class="modal-header bg-warning">
        <h4 class="modal-title">Konfirmasi</h4>
      ...
      <div class="modal-body">
        <p>tolak akses petugas untuk melihat detail pemeriksaan?</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-success" data-dismiss="modal">Tidak</button>
        <form action="<?php echo base_url(); ?>index.php/Welcome/tolakAkses" method="POST">
          <button id="delAlumni" name="delAlumni" class="btn btn-danger" value="">Ya</a>
        </form>
      </div>
    </div>
...
<script>
  $(document).ready(function() {
    $('#kasiAkses').on('show.bs.modal', function(event) {
      var button = $(event.relatedTarget);
      var modal = $(this);
      modal.find('.modal-footer #delAlumni').attr('value', button.data('id'));
    })
    $('#tolakAkses').on('show.bs.modal', function(event) {
      var button = $(event.relatedTarget);
      var modal = $(this);
      modal.find('.modal-footer #delAlumni').attr('value', button.data('id'));
    })
