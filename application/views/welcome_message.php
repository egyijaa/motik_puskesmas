...
<!-- jQuery -->
<script
            src="<?php echo base_url(); ?>/assets/bootstrap/plugins/bs-custom-file-input/bs-custom-file-input.min.js">
        </script>
        <!-- jQuery -->
        <script src="<?php echo base_url(); ?>/assets/adminLte/plugins/jquery/jquery.min.js?t=<?php echo time();?>">
        </script>
        <!-- Bootstrap 4 -->
        <script
        ...
        <!-- Toastr -->
        <script src="<?php echo base_url(); ?>/assets/bootstrap/plugins/toastr/toastr.min.js?t=<?php echo time();?>">
        </script>
